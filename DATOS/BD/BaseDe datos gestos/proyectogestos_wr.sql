CREATE DATABASE  IF NOT EXISTS `proyectogestos` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `proyectogestos`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: localhost    Database: proyectogestos
-- ------------------------------------------------------
...
CREATE TABLE `wr` (
  ...
  `pos3` double NOT NULL,
  `pos4` double NOT NULL,
...
-- Dump completed on 2014-07-13 11:03:16
